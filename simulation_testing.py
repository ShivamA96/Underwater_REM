...
class Simulation(animation.TimedAnimation):
    ...
    def __init__(self, n_particles, mass, rad, T, V, max_time, dt=0.1):
        """
    ...
    #         writer.writerow(["Index", "X", "Y", "Z"])  # Write the header

    #         for i, particle in enumerate(self.PART):
    #             writer.writerow([i, particle.x, particle.y, particle.z])

    #     # Call this function again in 100 milliseconds
    #     self.after(100, self.store_coordinates)
    ...
    def init_figures(self):
        ...
        # Plot the cone
        self.ax1.plot_trisurf(x, y, z, color='b', alpha=0.3, linewidth=0, antialiased=True)
        ...
        self.circle_xy = plt.Rectangle((-0.25, -0.25), 0.5, 0.5 , color='r', fill=False)
        
        self.ax2.add_patch(self.circle_xy)
    ...
    #     velocities = [self.v for particle in self.particles]
    # return velocities
